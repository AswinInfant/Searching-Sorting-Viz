...
function Insertion()
{
    ...
    enable_buttons();
    document.getElementById('avg').value="O(n^2)";
     document.getElementById('wor').value="O(n^2)";
     document.getElementById('best').value="O(n)";
     document.getElementById('swap').value=swap_count;
}
